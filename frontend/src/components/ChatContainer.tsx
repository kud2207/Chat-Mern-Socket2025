...
const ChatContainer = () => {
  ...
  useEffect(() => {
    // Fonction async pour récupérer les messages
  ...
  if (isMessagesLoading) return (
    <div className="mt-14 flex-1 flex flex-col overflow-auto">
      <ChatHeader />
      <MessageSkeleton />
      <MessageInput />
    </div>
                ...
                <img
                  src={
                    message.senderId === authUser?._id
                      ? authUser.profilePic || "/express.png"
                      : selectedUser?.profilePic || "/express.png"
                  }
                  alt="profile pic"
                />
              </div>
